...
class CreateMatchesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('matches', function (Blueprint $table) {
            ...
            $table->foreign('stadium_id', 'matches_toss_winner_foreign_key')->references('id')->on('teams')->onDelete('cascade');
            $table->foreign('match_player', 'matches_match_player_foreign_key')->references('id')->on('players')->onDelete('cascade');
            $table->foreign('winner', 'matches_winner_key')->references('id')->on('teams')->onDelete('cascade');
